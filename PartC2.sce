...
// Title: PART C - Trapezoidal Rule - Program Code for SciLab
// File name: PartC2.sce
...
mprintf('INTEGRATION OF DATA BETWEEN LIMITS, BY THE TRAPEZOIDAL RULE:')
...
// START calculate integral by Trapezoidal Rule...
h=(Xb-Xa)/Nx
s=f(Xa)+f(Xb)
for i=1:Nx-1
    s=s+2*f(Xa+i*h);
...
I=h/2*s
// END calculate integral by Trapezoidal Rule.
